...
import { Github, Instagram, Mail, TerminalSquare, CodeXml, CheckCircle2, BookOpen, Brain, Lightbulb, ArrowRight, MonitorSmartphone, Database, Palette } from 'lucide-react';
...
export default function HomePage() {
  return (
    <PageWrapper className="overflow-hidden">
      <DecorativeBlob pathD={blobPath1} className="top-0 left-0 w-64 h-64 md:w-96 md:h-96 opacity-30 dark:opacity-20" style={{ transform: 'translate(-40%, -40%) rotate(45deg)' }} />
      <DecorativeBlob pathD={blobPath2} className="bottom-0 right-0 w-56 h-56 md:w-80 md:h-80 opacity-20 dark:opacity-10" style={{ transform: 'translate(40%, 40%) rotate(-30deg)' }} />
      
      <section className="relative py-16 md:py-24 lg:py-28">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
          <div className="text-center md:text-left animate-fadeIn">
            <p className="text-primary font-semibold mb-1 text-lg sm:text-xl">HI!</p>
            ...
            <h2 className="font-headline text-2xl sm:text-3xl md:text-4xl font-semibold tracking-tight text-foreground/80 mt-1">
            ...
            <Button asChild size="lg" className="mt-8 sm:mt-10 shadow-lg hover:shadow-xl transition-shadow rounded-full px-8 py-3 text-sm sm:text-base">
              <Link href="/contact">
                LET'S TALK
              </Link>
            </Button>
          ...
          <div className="relative animate-fadeIn" style={{animationDelay: '0.2s'}}>
            <Image
              ...
              priority
            />
             <DecorativeBlob pathD={blobPath3} className="top-1/2 left-1/2 w-72 h-72 opacity-40 dark:opacity-25" style={{ transform: 'translate(-50%, -50%) scale(0.8) rotate(15deg)' }}/>
          </div>
        </div>
      </section>

      <section className="py-10 md:py-12 bg-secondary/30 dark:bg-secondary/10">
        <div className="container mx-auto px-4">
          <Card className="p-5 sm:p-6 shadow-lg rounded-xl bg-card">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 text-center md:text-left items-center">
              <div>
                <h3 className="font-semibold text-xs sm:text-sm text-muted-foreground mb-1.5">My Tech Stack</h3>
                <div className="flex justify-center md:justify-start gap-2.5 sm:gap-3 text-foreground">
                  <CodeXml className="h-5 w-5 sm:h-6 sm:w-6 hover:text-primary transition-colors" title="Web Development" />
                  <TerminalSquare className="h-5 w-5 sm:h-6 sm:w-6 hover:text-primary transition-colors" title="Command Line & Scripting" />
                  <Brain className="h-5 w-5 sm:h-6 sm:w-6 hover:text-primary transition-colors" title="Exploring AI/ML" />
                </div>
              </div>
              <div>
                <h3 className="font-semibold text-xs sm:text-sm text-muted-foreground mb-1.5">Connect With Me</h3>
                <div className="flex justify-center md:justify-start gap-2.5 sm:gap-3 text-foreground">
                  <Link href="https://github.com/bipash25" target="_blank" rel="noopener noreferrer" aria-label="GitHub"><Github className="h-5 w-5 sm:h-6 sm:w-6 hover:text-primary transition-colors" /></Link>
                  <Link href="https://instagram.com/the.bipro" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><Instagram className="h-5 w-5 sm:h-6 sm:w-6 hover:text-primary transition-colors" /></Link>
                  <Link href="/blog" aria-label="My Blog"><BookOpen className="h-5 w-5 sm:h-6 sm:w-6 hover:text-primary transition-colors" /></Link>
                </div>
              </div>
              <div>
                <h3 className="font-semibold text-xs sm:text-sm text-muted-foreground mb-1.5">Contact me</h3>
                <Link href="mailto:secondbipro@gmail.com" className="flex items-center justify-center md:justify-start gap-1 text-foreground hover:text-primary transition-colors text-xs sm:text-sm">
                  <Mail className="h-4 w-4 sm:h-5 sm:w-5" /> secondbipro@gmail.com
                </Link>
              </div>
            </div>
          </Card>
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        <DecorativeBlob pathD={blobPath2} className="top-10 -left-20 w-96 h-96 opacity-20 dark:opacity-10" style={{transform: 'rotate(-60deg) scaleX(-1)'}}/>
        <DecorativeBlob pathD={blobPath1} className="bottom-5 -right-20 w-80 h-80 opacity-10 dark:opacity-5" style={{transform: 'rotate(30deg)'}}/>
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          <div className="relative order-2 md:order-1 animate-fadeIn">
             <DecorativeBlob pathD={blobPath3} className="top-0 left-0 w-full h-full opacity-20 dark:opacity-15" style={{transform: 'scale(1.2) translate(-10%, -10%)'}}/>
            <Image
      ...
      <section className="py-16 md:py-24 bg-secondary/30 dark:bg-secondary/10 relative overflow-hidden">
        <DecorativeBlob pathD={blobPath1} className="-top-20 -right-32 w-96 h-96 opacity-20 dark:opacity-10 transform rotate-90" />
        <DecorativeBlob pathD={blobPath2} className="bottom-5 -left-20 w-80 h-80 opacity-10 dark:opacity-5 transform -rotate-45 scale-x-[-1]" />
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={service.title} className="text-center p-8 shadow-xl hover:shadow-2xl transition-shadow duration-300 rounded-xl animate-fadeIn bg-card" style={{animationDelay: `${index * 0.15}s`}}>
      ...
      <section className="py-16 md:py-24 relative overflow-hidden">
        <DecorativeBlob pathD={blobPath3} className="top-1/4 -left-24 w-96 h-96 opacity-10 dark:opacity-5 transform rotate-120" />
        <DecorativeBlob pathD={blobPath1} className="bottom-1/4 -right-24 w-80 h-80 opacity-15 dark:opacity-10 transform -rotate-120" />
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            {[
              ...
              <Card key={project.title} className={cn("overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 rounded-xl animate-fadeIn bg-card", project.className)} style={{animationDelay: `${index * 0.15}s`}}>
      ...
      <section className="py-16 md:py-24 relative overflow-hidden bg-secondary/30 dark:bg-secondary/10">
        <DecorativeBlob pathD={blobPath2} className="top-10 -left-24 w-96 h-96 opacity-10 dark:opacity-5 transform -rotate-30 scale-x-[-1]" />
        <DecorativeBlob pathD={blobPath3} className="bottom-0 -right-20 w-80 h-80 opacity-10 dark:opacity-5 transform rotate-60" />
